...
export const setImmediate = noopAsync;
...
export const get = () => ({});
// #360: node:http's reason-phrase table. request()/get() above are already
// no-ops in the browser bundle (no real socket layer here), so this value is
// never read on a live request path — it exists only so a static import of
// STATUS_CODES (fileDetector.ts's HTTP-status error formatting) resolves at
// build time instead of failing the whole browser bundle. Kept a faithful
// subset of Node's real table rather than an empty object, in case anything
// ever reads it directly.
export const STATUS_CODES = { 100:'Continue',101:'Switching Protocols',200:'OK',201:'Created',202:'Accepted',204:'No Content',206:'Partial Content',301:'Moved Permanently',302:'Found',304:'Not Modified',307:'Temporary Redirect',308:'Permanent Redirect',400:'Bad Request',401:'Unauthorized',402:'Payment Required',403:'Forbidden',404:'Not Found',405:'Method Not Allowed',406:'Not Acceptable',408:'Request Timeout',409:'Conflict',410:'Gone',411:'Length Required',412:'Precondition Failed',413:'Payload Too Large',414:'URI Too Long',415:'Unsupported Media Type',416:'Range Not Satisfiable',417:'Expectation Failed',422:'Unprocessable Entity',425:'Too Early',426:'Upgrade Required',428:'Precondition Required',429:'Too Many Requests',431:'Request Header Fields Too Large',451:'Unavailable For Legal Reasons',500:'Internal Server Error',501:'Not Implemented',502:'Bad Gateway',503:'Service Unavailable',504:'Gateway Timeout',505:'HTTP Version Not Supported' };
